  ...
  return (
    <div className="space-y-5 lg:max-w-4xl">
      ...
      <p className="text-center text-xs text-muted lg:text-left">
        <Link to="/associations" className="underline">Associations</Link> · <a href="https://zevent.gdoc.fr/" className="underline" target="_blank" rel="noreferrer">InGDoc</a> · <a href="https://github.com/raphplt/zevent-radar" className="underline" target="_blank" rel="noreferrer">Code source</a> · <Link to="/status" className="underline">État du service</Link> · <Link to="/about" className="underline">À propos</Link> · <Link to="/legal" className="underline">Mentions légales</Link>
      </p>
    </div>
  );
}
